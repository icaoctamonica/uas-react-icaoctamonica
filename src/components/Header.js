...
const Header = () => {
  ...
  return (
    <>
      <header className="bg-yellow text-white navbar navbar-expand-md navbar-dark d-print-none">
        <div className="container-xl">
          ...
          <h1 className="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <Link to="/">
              <img
                src="https://media.istockphoto.com/vectors/bakery-logo-design-vector-id1198287063"
                width="110"
                height="32"
                alt="Tabler"
            ...
            Toko Bakery Ica Octa Murah Meriah
          </h1>
